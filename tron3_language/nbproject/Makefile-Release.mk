...
${OBJECTDIR}/src/tron3/language/Language.o: src/tron3/language/Language.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron3/language/Language.o src/tron3/language/Language.cpp

${OBJECTDIR}/src/tron3/language/LanguageArea.o: src/tron3/language/LanguageArea.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron3/language
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron3/language/LanguageArea.o src/tron3/language/LanguageArea.cpp

${OBJECTDIR}/src/tron3/language/Slang.o: src/tron3/language/Slang.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron3/language
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron3/language/Slang.o src/tron3/language/Slang.cpp
