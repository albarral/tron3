...
LDLIBSOPTIONS=-Wl,-rpath,../tron3_knowledge/dist/Debug/GNU-Linux -L../tron3_knowledge/dist/Debug/GNU-Linux -ltron3_knowledge -Wl,-rpath,../tron3_interpret/dist/Debug/GNU-Linux -L../tron3_interpret/dist/Debug/GNU-Linux -ltron3_interpret -Wl,-rpath,../../tron/tron_util/dist/Debug/GNU-Linux -L../../tron/tron_util/dist/Debug/GNU-Linux -ltron_util -llog4cxx
...
${OBJECTDIR}/src/TestInterpret.o: src/TestInterpret.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../tron3_knowledge/src -I../tron3_interpret/src -I../../tron/tron_util/src -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TestInterpret.o src/TestInterpret.cpp

${OBJECTDIR}/src/TestKnowledge.o: src/TestKnowledge.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../tron3_knowledge/src -I../tron3_interpret/src -I../../tron/tron_util/src -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TestKnowledge.o src/TestKnowledge.cpp

${OBJECTDIR}/src/main.o: src/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../tron3_knowledge/src -I../tron3_interpret/src -I../../tron/tron_util/src -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp
